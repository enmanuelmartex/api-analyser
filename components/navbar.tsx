      ...
      >
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-lg border border-zinc-800 bg-zinc-900/70 px-3 py-1.5 text-sm font-medium text-zinc-200 transition-colors hover:border-zinc-700 hover:bg-zinc-800 hover:text-white"
          >
          ...
          <button
            ...
            className="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-zinc-800 text-zinc-400 transition-colors hover:text-white md:hidden"
          >
        ...
        <div id="mobile-nav" className="border-t border-zinc-800/60 px-5 pb-4 pt-2 md:hidden">
          {navLinks.map((link) => (
            <a
              ...
              className="block rounded-lg px-2 py-2.5 text-sm text-zinc-300 transition-colors hover:bg-zinc-900 hover:text-white"
            >
              {link.label}
            </a>
          ))}
