...
exports.BrokenAuthPlugin = void 0;
...
class BrokenAuthPlugin extends scanner_types_1.BasePlugin {
    constructor() {
        super(...arguments);
        this.manifest = {
            ...
            license: 'MIT',
            category: plugin_manifest_types_1.PluginCategory.AUTHENTICATION,
        ...
        for (const endpoint of testEndpoints) {
            ...
            try {
                const resp = await axios_1.default.request({
                    ...
                    url,
                    headers: { 'User-Agent': brand_1.appBrand.scannerUserAgent, 'Accept': 'application/json' },
                ...
                if (resp.status < 400) {
                    findings.push({
                        ...
                        httpRequest: this.buildRequestString(endpoint.method, url, { 'User-Agent': brand_1.appBrand.scannerUserAgent, Accept: 'application/json' }),
                        httpResponse: this.buildResponseString(resp.status, resp.headers, typeof resp.data === 'object' ? JSON.stringify(resp.data).substring(0, 500) : String(resp.data).substring(0, 500)),
                ...
                try {
                    ...
                    if (resp.status < 400) {
                        findings.push({
                            ...
                            httpResponse: this.buildResponseString(resp.status, resp.headers, null),
...
exports.BrokenAuthPlugin = BrokenAuthPlugin;
//# sourceMappingURL=broken-auth.plugin.js.map